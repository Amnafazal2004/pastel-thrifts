...
const Feedback = () => {
  ...
  <h2 className="text-2xl md:text-3xl font-bold text-[#155076] text-center mb-4">
  ...
  <button className="bg-[#155076] text-white text-sm md:text-base py-2 px-6 rounded-full hover:bg-[#4B85B4] transition">
    Leave Feedback
  </button>
</div>
